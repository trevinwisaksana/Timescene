...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // Locator.api.googleAPIKey = Constants.Key.googlePlacesAPI
        GMSServices.provideAPIKey(Constants.Key.googleMapsAPI)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Scene")
...
extension AppDelegate {
    ...
    func configureInitialRootViewController(for window: UIWindow?) {
        ...
        if let userData = defaults.object(forKey: Constants.UserDefaults.currentUser) as? Data,
            ...
            initialViewController = UIStoryboard.initialViewController(for: .container)
